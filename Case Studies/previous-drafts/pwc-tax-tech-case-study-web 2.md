...
**Headline:** A team of 60+ engineers building some of the most powerful tax software in the industry had never worked with a designer. Two years later, they refused to start a sprint without one.

**Subhead:** I was one of three UX practitioners brought in to establish user experience as a discipline within PwC's Tax Technology group. I led the initiative that moved the organization from NN/g UX Maturity Stage 1 (Absent) to Stage 5 (Integrated) across 8 to 10 products in two years.

> **Metric callout:** 60–70 team members certified in UX methods by Nielsen Norman Group. UX designers embedded on every product with a user interface. Generative research established as standard operating procedure.

[Hero image: TBD – consider a before/after visual concept, or a photo from one of the NN/g training sessions if available]
...
[Image: TBD – if available, a representative screenshot of the pre-UX interface state, or a visual that conveys the "powerful but unpolished" contrast]
...
## Decision 1: Earning trust before asking for change

### Moving from Stage 1 (Absent) to Stage 2 (Limited)
...
> **Context callout:** The key insight was sequencing. We did not ask anyone to change their process until they had already seen the results of ours. Trust came from evidence, not authority.

[Image: TBD – consider a photo from a brown bag session or collaborative whiteboard moment if available]

---

## Decision 2: Building shared infrastructure across the product suite

### Moving from Stage 3 (Emergent) to Stage 4 (Structured)
...
[Image: TBD – design system components, or a before/after showing the visual unification across products]

---

## Decision 3: Research that redirected a project before a single screen was designed
...
> **Quote placeholder:** [Quote TBD – from Jake Wilson on the impact of this research redirect. Pia to source.]

[Image: TBD – contextual inquiry artifacts, workflow mapping, or findings presentation if available]

---

## Decision 4: Making UX everyone's responsibility

### Moving from Stage 4 (Structured) to Stage 5 (Integrated)
...
Two things made the difference. The first was contextual inquiry and generative research becoming standard practice. Because our users were internal to PwC, setting up research sessions in their own workspaces was far easier than it would have been with external consumers. I used that advantage deliberately. We showed up for project kickoffs not with wireframes but with insights from contextual inquiries we had already completed. PMs began to see research not as a delay but as a competitive advantage that made their products better from the first sprint.
...
> **Metric: UX Maturity** – NN/g Stage 1 (Absent) to Stage 5 (Integrated) in two years across a portfolio of 8 to 10 products.

> **Metric: Team growth** – UX practice grew from 0 to 3 (founding team), then to 5, then to 7+ with contractors supplementing. Every product with a user interface had a designer assigned.

> **Metric: Organizational capability** – 60 to 70 team members earned NN/g UX certification. Generative research became standard operating procedure. PMs required UX deliverables before sprint planning.

> **Metric: Sustainability** – When I transitioned to PwC Digital, David and Mike had moved on from the firm, and I handed a smooth-running team to the next manager. The practice I built did not depend on the people who started it.
...
> **Quote placeholder:** [Quote TBD – from Tax Technology leadership or a PM on the impact of the UX integration. Pia to source.]

[Image grid: TBD – consider before/after product screenshots showing the visual evolution, or a timeline graphic mapping the maturity stages to specific milestones]
...
**Case study type:** Leadership (organizational transformation / UX maturity)

**Portfolio positioning:** This is the third case study in the portfolio, alongside the Southwest Airlines Ops Suite (IC) and the PwC Digital team-building case study (Leadership). Together, the two PwC case studies show different facets of design leadership: Tax Tech demonstrates building a UX practice from nothing in a resistant organization, while PwC Digital demonstrates scaling an existing practice during rapid growth. The SWA case study demonstrates IC design craft. The three together signal T-shaped leadership with depth in both organizational transformation and hands-on design.

**NN/g maturity model:** Stages are referenced explicitly by name and number throughout. Any hiring manager familiar with the model will recognize the framework immediately. Those unfamiliar will still follow the narrative because each stage is described in plain language when introduced.

**NDA considerations:** This case study describes organizational process and outcomes rather than specific product interfaces. Verify with Pia whether any product screenshots can be shown or whether the case study should rely on process artifacts (design system samples, training photos, timeline graphics) instead.

**Quote placeholders:** Two placeholders. One in Decision 3 for Jake Wilson's response to the research redirect (Pia confirms she saved this quote). One in the Outcomes section for Tax Technology leadership or a PM on the impact of UX integration. The colleague messages shared (Kim Harris, Gilbert Pazos, etc.) appear to be from the PwC Digital period (2021) rather than Tax Tech (2017–2018); verify before using any of them here.

**Metrics note:** All metrics are directional or anecdotal rather than hard business outcomes like pitch win-rate improvement. This is acknowledged honestly in the draft. If Pia can source any data on pitch outcomes or client feedback from the Tax Technology leadership, that would strengthen the business case significantly.

**Images needed from Pia:**
- Pre-UX product interface screenshot (if NDA allows)
- Post-UX product interface screenshot for before/after comparison
- Design system components from the Tax Tech library
- Photo from NN/g training session or brown bag (if available)
- Artifacts from the Boston research redirect: workflow maps, findings deck, or contextual inquiry photos (Decision 3)
- Timeline or maturity-stage progression graphic (could be designed for the portfolio)
- Any collaborative artifacts: whiteboard photos, journey maps, co-design session output

**Total text sections:** 9 (hero + 7 body sections + editorial notes). Roughly equivalent to the SWA and Agent OS case study lengths.

**Open questions for Pia:**
1. Was there a specific name for the agency that built the design system components? (Pia recalls a Denver-based agency whose name was shortened from two words to one.)
2. Do any of the uploaded colleague screenshots (Images 1–10) belong to the Tax Tech era? The Michele Wong message referencing "the nardo times" appears to connect to Andy Nardo and this initiative.
3. Can you share any product screenshots, or does this case study need to stay at the process/outcome level?
4. The design system was eventually integrated into the Tax SDK. Is there anything worth noting about that transition, or is it sufficient as a sustainability proof point in the outcomes?
5. Do you have any artifacts from the Boston research redirect? Workflow maps, findings decks, or photos from the contextual inquiries would strengthen Decision 3.
